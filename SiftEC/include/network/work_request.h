...
public:
    ...
    void *getConnection(int node_id);
    ...
    void setConnection(int node_id, void *conn);
    ...
    void copyValue(int nodeId, char* value);
    ...
    void setValue(int nodeId, char *value);
...
private:
    ...
    void *conn[TOTAL_MEMORY_SERVERS];
};
