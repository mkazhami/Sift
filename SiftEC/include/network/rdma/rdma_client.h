...
public:
    ...
    */
    ...
    virtual int Read(WorkRequest* workReq)=0;
    virtual int Write(WorkRequest* workReq)=0;
    virtual int Write(std::vector<WorkRequest*> &workReqs)=0;
    virtual int CompSwap(WorkRequest* workReq)=0;
